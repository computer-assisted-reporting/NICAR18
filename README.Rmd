...
Our data collection method is described in detail below. Hoewver, if you want to get straight to the data, simply run the following code:
...
To explore the Twitter data, we recommend using the [tidyverse](http://tidyverse.org) packages.
